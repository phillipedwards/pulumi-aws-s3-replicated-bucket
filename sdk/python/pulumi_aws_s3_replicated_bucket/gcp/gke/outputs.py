...
class NodePoolAutoscaling(dict):
    ...
    def __init__(__self__, *,
                 location_policy: Optional['_container.v1.NodePoolAutoscalingLocationPolicy'] = None):
        """
        :param '_container.v1.NodePoolAutoscalingLocationPolicy' location_policy: Location policy used when scaling up a nodepool.
        """
    ...
    def location_policy(self) -> Optional['_container.v1.NodePoolAutoscalingLocationPolicy']:
        """
